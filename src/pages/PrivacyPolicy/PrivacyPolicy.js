...
import { StyledContent } from './PrivacyPolicyStyles';
          ...
          <li>
            ...
            <ol>
              <li>
                ...
                strony internetowej <b>www.czarogrod.pl</b> jest{' '}
                <b>Agnieszka Lizończyk</b> będąca osobą fizyczną, zamieszkałą
                ul. Prusa 25a, 32-566 Alwernia, adres poczty elektronicznej
                (e-mail): kontakt@czarogrod.pl, zwana dalej “Administratorem”.{' '}
              </li>
              <li>
                ...
                rozporządzenie o ochronie danych), zwane dalej RODO oraz ustawą
          ...
          <li>
            ...
            <ol>
              <li>
                ...
                <b>www.czarogrod.pl</b> w przypadku:
                <ol>
                  <li>
              ...
              <li>
                <b>RODZAJ PRZETWARZANYCH DANYCH OSOBOWYCH.</b>
              ...
              <li>
                <b>OKRES ARCHIWIZACJI DANYCH OSOBOWYCH.</b>
                Dane osobowe użytkowników przechowywane są przez Administratora:
                <ol>
                  <li>
                    w przypadku, gdy podstawą przetwarzania danych jest
                    ...
                    nie stanowi inaczej, termin przedawnienia wynosi lat sześć,
                    a dla roszczeń o świadczenia okresowe oraz roszczeń
                    związanych z prowadzeniem działalności gospodarczej – trzy
                    lata.
                  </li>
                  <li>
                    w przypadku, gdy podstawą przetwarzania danych jest zgoda,
                    ...
                    stanowi inaczej, termin przedawnienia wynosi lat sześć, a
                    dla roszczeń o świadczenia okresowe oraz roszczeń związanych
                    z prowadzeniem działalności gospodarczej – trzy lata.
                  </li>
                  <li>
                    Podczas korzystania ze strony internetowej mogą być
                    pobierane dodatkowe informacje, w szczególności: adres IP
                    przypisany do komputera użytkownika lub zewnętrzny adres IP
                    dostawcy Internetu, nazwa domeny, rodzaj przeglądarki, czas
                    dostępu, typ systemu operacyjnego.
                  </li>
                  <li>
                    Od użytkowników mogą być także gromadzone dane nawigacyjne,
                    w tym informacje o linkach i odnośnikach, w które zdecydują
                    się kliknąć lub innych czynnościach, podejmowanych na
                    stronie internetowej. Podstawą prawną tego rodzaju czynności
                    jest prawnie uzasadniony interes Administratora (art. 6 ust.
                    1 lit. f RODO), polegający na ułatwieniu korzystania z usług
                  ...
                  <li>
                    Dane osobowe będą przetwarzane także w sposób
                    zautomatyzowany w formie profilowania, o ile użytkownik
                    wyrazi na to zgodę na podstawie art. 6 ust. 1 lit. a) RODO.
                    Konsekwencją profilowania będzie przypisanie danej osobie
                    profilu w celu podejmowania dotyczących jej decyzji bądź
                    analizy lub przewidywania jej preferencji, zachowań i
                    postaw.
                  </li>
                  <li>
            ...
            <ol>
              ...
              <li>
                ...
                <ol>
                  ...
                  <li>
                    Usunięcie danych (tzw. prawo do bycia zapomnianym) – art. 17
                    RODO.
                  </li>
              ...
              <li>
                ...
                stosowną wiadomość e-mail na adres: kontakt@czarogrod.pl
              </li>
              <li>
